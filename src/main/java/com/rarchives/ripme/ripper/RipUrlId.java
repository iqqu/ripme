...
public class RipUrlId {
     ...
     */
    public RipUrlId(Class<? extends AbstractRipper> ripper, String ripUrlId) {
        if (ripper == null) {
     ...
     */
    @Deprecated
    public RipUrlId(Class<? extends AbstractRipper> ripper, URL url) {
        if (ripper == null) {
            throw new IllegalArgumentException("ripper cannot be null");
        }
        if (url == null) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(ripper, ripUrlId1.ripper) && Objects.equals(ripUrlId, ripUrlId1.ripUrlId) && Objects.equals(url, ripUrlId1.url);
    }

    @Override
    public int hashCode() {
        return Objects.hash(ripper, ripUrlId, url);
    }
    ...
    public String toString() {
        ...
        return ripper.getSimpleName() + ": " + ripUrlId;
    }
}
